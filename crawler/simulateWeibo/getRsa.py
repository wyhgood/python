import PyV8
class Test():
    def js(self, servertime, nonce, passwd, pubkey):
        ctxt = PyV8.JSContext()
        ctxt.enter()
        func = ctxt.eval(
        '''
        (function(servertime, nonce, passwd, pubkey){
        ...
        (function() {
            ...
            if (T == null) {
                ...
                ab = 0;
                var I;
                if (0 && 0 && window.crypto && typeof (window.crypto.random) === "function") {
        ...
        var b = e.encrypt([servertime, nonce].join("\\t") +"\\n"+passwd);

        return b;
        })
        ''')
        return func(servertime, nonce, passwd, pubkey)

if __name__=='__main__':
    servertime = '1446309366'
    nonce = 'OF28XH'
    passwd = 'pxfg73uv'
    crawler = Test()
    print crawler.js(servertime, nonce, passwd, pubkey)
